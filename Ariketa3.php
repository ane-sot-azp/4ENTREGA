...
//mota parametroa hartzen du eta balio bat gordetzen du $bilatu parametroan, eta ezer ez badu, ' 'hutsunea ezartzen dio
...
<head>
<title>3.Ariketa</title> <!-- web orrian agertuko den izenburua -->
...
<body>
    <div class="container">
        <form action="Ariketa3.php" method="GET"> <!-- produktuak bilatzeko formularioa -->
