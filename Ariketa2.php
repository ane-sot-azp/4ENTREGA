...
//izenaBilatu parametroa GET metodoan bidali den ala ez egiaztatzen du, bidali bada, $bilatu aldagaiean gordetzen da, eta bidali ez bada, ' ' hutsa gordetzen du $aldagaian
...
<head>
    <title>2.Ariketa</title> <!-- web orrian agertuko den izenburua -->
...
<body>
    <div class="container"> 
        <form action="Ariketa2.php" method="GET"> <!-- produktuak bilatzeko formularioa -->
        ...
        $conn->close(); //datu baseekin konexioa isten da
